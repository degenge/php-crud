<?php require 'includes/header.php' ?>
    ...
    <section >
        ...
        <h1 class="text-3xl text-blue-300 py-3" >Teacher</h1 >

        <?php require 'form_teacher.php'; ?>
                ...
                <tr >
                    <td class="px-6 py-4 text-center" >
                        <form method="post" action="<?php echo htmlspecialchars('index.php?page=teacher'); ?>" class="" >
                            <button type="submit" id="edit" name="update" value="<?php echo $teacher['ID']; ?>"
                    ...
                    <td class="px-6 py-4 text-center" ><?php echo $teacher['ID']; ?></td >
                    <td class="px-6 py-4 text-center" ><?php echo $teacher['name_first']; ?></td >
                    <td class="px-6 py-4 text-center" ><?php echo $teacher['name_last']; ?></td >
                    <td class="px-6 py-4 text-center" ><?php echo $teacher['email']; ?></td >
                    <td class="px-6 py-4 text-center" >
                        <?php foreach (Teacher::getTeacherClassgroup($teacher['ID']) as $classItem) { ?>
                            <p><?php echo $classItem['name']; ?></p>
                        <?php } ?>
                    </td >
                    <td class="px-6 py-4 text-center" >
                        <?php require 'form_teacher_modal_delete.php'; ?>
                    </td >
                </tr >
            <?php } ?>
